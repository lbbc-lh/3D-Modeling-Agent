...
import uvicorn
import prompts
from slot_process import intent_slot, normalize_blender_action
from function import BLENDER_TOOLS, tools1
...
## 创建FastAPI应用
app = FastAPI()
SERVICE_NAME = os.getenv("SERVICE_NAME", "chatnlu-service")
...
def predict_blender_action(tool_calls):
    return normalize_blender_action({"function": tool_calls})
...
async def inference(request: Request):
    ...
    trace_id = ensure_trace_id(json_info.get("trace_id", "1"))
